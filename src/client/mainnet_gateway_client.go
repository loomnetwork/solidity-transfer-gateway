...
type MainnetGatewayClient struct {
	...
	contract  *ethcontract.MainnetGatewayContract
...
func ConnectToMainnetGateway(ethClient *ethclient.Client, address string) (*MainnetGatewayClient, error) {
	contractAddr := common.HexToAddress(address)
	contract, err := ethcontract.NewMainnetGatewayContract(contractAddr, ethClient)
	if err != nil {
		return nil, err
	}
